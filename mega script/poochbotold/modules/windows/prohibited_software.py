...
class ProhibitedSoftware(module.Module):
    """Runs Bulk Crap Uninstaller to automatically remove programs."""

    name: str = "windows.prohibited_software"
    aliases = ["prohibited_software", "ps"]
